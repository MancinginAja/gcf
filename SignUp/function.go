...
func init() {
	functions.HTTP("Manja", manja_register)
}

func manja_register(w http.ResponseWriter, r *http.Request) {
	...
	fmt.Fprintf(w, manja.SignUpHandler("MONGOSTRING", "db_manja", "user", r))
